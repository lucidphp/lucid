...
namespace Lucid\Http\Tests\Session\Data;
...
class MetaDataTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function itShouldBeInstantiable()
    {
        ...
        $this->assertInstanceof('Lucid\Http\ParameterInterface', $instance);
        $this->assertInstanceof('Lucid\Http\Session\Data\AttributesInterface', $instance);
    }
