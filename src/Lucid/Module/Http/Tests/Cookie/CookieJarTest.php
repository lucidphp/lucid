...
namespace Lucid\Module\Http\Tests\Cookie;

use Lucid\Module\Http\Cookie\Cookie;
use Lucid\Module\Http\Cookie\CookieJar;
...
class CookieJarTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceof('Lucid\Module\Http\Cookie\CookieJarInterface', new CookieJar);
    }
    ...
    {
        $c = $this->getMock('Lucid\Module\Http\Cookie\CookieInterface');
