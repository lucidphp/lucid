...
/*
 * This File is part of the Lucid\Template\Tests\Loader package
 *
 ...
 *
 * @package Lucid\Template\Tests\Loader
 * @version $Id$
...
class FilesystemLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function itShouldResolveResourceIfNameIsAbsolutePath()
    {
        ...
        $this->assertInstanceof('Lucid\Template\Resource\FileResource', $loader->load($id));
    }

    /**
     * @test
     * @expectedException \Lucid\Template\Exception\LoaderException
     */
    ...
    {
        return $this->getMock('Lucid\Template\IdentityInterface');
    }
}
