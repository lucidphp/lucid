...
use Lucid\Http\Response\Body;
use Lucid\Http\Response\Reason;
use Lucid\Http\Response\Headers;
...
class Response implements ResponseInterface
{
    ...
    /**
     * Sets the http/<version> StatusHeader
     *
     * @return void
     */
